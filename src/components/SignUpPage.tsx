...
import { View,Text,StyleSheet,Image,Button, Touchable, TouchableOpacity, Alert, Dimensions, SafeAreaView, TextInput } from "react-native";
    ...
    return (
        <SafeAreaView style={styles.wrapper}>
            ...
            <View style={styles.topBox1}>               
                <TextInput>UserName / Email Address</TextInput>
            </View>
...
const SignUpPage = ()=>{
    return (
        <Stack.Navigator initialRouteName="SignUpNow"
            screenOptions={{
              // headerShown:false
            }}
        >
           <Stack.Screen name="SignUpNow" component={SignUpPageMain} />
            <Stack.Screen name="LoginNow" component={LoginPage} options ={{title:"Login into app"}}/> 
